    ...
    if (hero.hp > (hero.maxHp - 30)) {
      hero.id = setInterval(function() {
        if (i == 1) {
          ...
          document.getElementsByClassName("heal-text")[0].classList.add("healed");
          document.getElementsByClassName("heal-text")[0].textContent = (hero.maxHp - hero.hp);
        }
        ...
        if (i > 8) {
          ...
          document.getElementsByClassName("heal-text")[0].classList.remove("healed");
